  ...
  return(
    ...
    <Container>
      <Row>
        ...
        <Col className="bg-warning  border-dark pt-20">2 of 2</Col>
      </Row>
      <Row>
        <Col className="bg-warning  border-dark pt-30">1 of 3</Col>
        <Col className="bg-success  border-dark pt-30">2 of 3</Col>
      ...
      <Row>
        ...
        <Col className="bg-warning  border-dark"> 4</Col>
      </Row>
